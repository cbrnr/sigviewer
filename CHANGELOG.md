...
- Update libxdf to 1.0.2, which skips empty marker samples in regular-rate string streams instead of turning each one into an event ([#166](https://github.com/cbrnr/sigviewer/pull/166) by [Clemens Brunner](https://github.com/cbrnr))
