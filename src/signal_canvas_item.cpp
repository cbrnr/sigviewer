...
void SignalCanvasItem::enableYGrid(bool enabled)
{
	drawYGrid_ = enabled;
}
...
// auto scale
void SignalCanvasItem::autoScale(bool update, ScaleMode auto_zoom_type)
{
    ...
    else
    {
    	...
    	setYZoom((maximum_ - minimum_) / (abs_max + abs_min));
