...
void SignalBrowserModel::setSignalBrowser(SignalBrowser* browser)

{
...

    {
        ...
        x_grid_item_ = new XGridCanvasItem(*this, signal_browser_);
...

    {
        ...
        channel_separator_item_ 
            ...
            = new ChannelSeparatorCanvasItem(*this, signal_browser_);
...

    {
        ...
        navigation_item_ = new NavigationCanvasItem(*this, signal_browser_);
...

{
    ...
    setState(STATE_INIT_BUFFER);

    signal_browser_->hide();
...
//    signal_browser_->show();
...

    {
        ...
        iter.value()->getRangeFromBuffer(2.0);
...
void SignalBrowserModel::setState(State state)
...

{
    ...
    signal_browser_->getCanvas()->resize(width, height);
    ...
    Int2SignalCanvasItemPtrMap::iterator signal_iter;
...

    {
        ...
        signal_iter.value()->setSize(width, signal_height_);

        signal_iter.value()->setX(0);

        signal_iter.value()->setY(y_pos);

        signal_iter.value()->setZ(SIGNAL_Z);
