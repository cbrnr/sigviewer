...
#
#   cmake [-DDEPS_DIR=<path>] -P cmake/download_deps.cmake
#
...
if(NOT DEFINED DEPS_DIR)
    # __FILE__ is the path to this script (go up one directory to get the repo root)
    cmake_path(GET CMAKE_CURRENT_LIST_FILE PARENT_PATH _script_dir)
    cmake_path(GET _script_dir PARENT_PATH _repo_root)
...
function(_fetch_dep lib_upper_name version platform dest_dir)
    ...
    if(_sha256 MATCHES "^TODO_")
        message(FATAL_ERROR
            ...
            "See cmake/download_deps.cmake for instructions on adding one.")
    endif()
...
file(WRITE "${_versions_file}"
    "# Auto-generated by cmake/download_deps.cmake — do not edit manually.\n"
